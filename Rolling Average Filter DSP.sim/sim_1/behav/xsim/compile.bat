...
REM
REM Generated by Vivado on Fri Mar 13 10:17:13 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj ADC1173_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ADC1173_tb_vlog.prj -log xvlog.log
