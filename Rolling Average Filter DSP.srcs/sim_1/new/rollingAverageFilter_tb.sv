...
module rollingAverageFilter_tb;
    ...
    initial begin
        ...
        check_output("Test 2 - Output Check", filter_Dout, 2); 
        ...
        check_output("Test 4 - New Output Check", filter_Dout, 3);
        ...
        check_output("Test 5 - Multiple Rolls Output Check", filter_Dout, 6);
